...
public class TurmaBean implements Serializable {
    ...
    private List<Sala> salas; // Lista de salas para o combo-box

    private TurmaDAO turmaDAO;
    private AnoLectivoDAO anoLectivoDAO;
    private ClasseDAO classeDAO;
    private SalaDAO salaDAO; // DAO da Sala
    ...
    public TurmaBean() {
        ...
        salaDAO = new SalaDAO(); // Inicialização do DAO
        ...
        carregarClasses();
        carregarSalas(); // Carrega as salas ao iniciar
    }
    ...
    public void novo() {
        ...
        turma.setSala(new Sala()); // CRUCIAL: Inicializa a sala para evitar erro no salvamento
